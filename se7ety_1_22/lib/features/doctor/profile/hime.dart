...
import 'package:se7ety_1_22/features/doctor/profile/data.dart';
  ...
  Future<void> generateAndSaveExcel() async {
    ...
    for (var i = 0; i < results.length; i++) {
      ...
      sheet
          ...
          .setText(results[i][3]['Kiswahili'][0].toString());
      sheet
          .getRangeByIndex(i + 5, 5)
          .setText(results[i][3]['Physics'][0].toString());
      sheet
          .getRangeByIndex(i + 5, 6)
          .setText(results[i][3]['Biology'][0].toString());
      sheet
          .getRangeByIndex(i + 5, 7)
          .setText(results[i][3]['Chemistry'][0].toString());
      sheet
          .getRangeByIndex(i + 5, 8)
          .setText(results[i][3]['Geography'][0].toString());
      sheet
          .getRangeByIndex(i + 5, 9)
          .setText(results[i][3]['Spanish'][0].toString());
      sheet
          .getRangeByIndex(i + 5, 10)
          .setText(results[i][3]['Total'][0].toString());
    }
